    ...
    <View style={styles.cardStyle}>
      <View style={styles.nameStyle}>
        ...
        <View style={{flexDirection: 'row'}}>
          <Text
            onPress={() => setDeleteAdd(true)}
            style={[styles.nameStyle, {color: Colors.APPCOLOR}]}>
            Delete{' '}
          </Text>
          <Text
            ...
            style={[
              styles.nameStyle,
              {color: Colors.APPCOLOR, marginLeft: Scale(10)},
            ]}>
            Edit
          </Text>
        </View>
      </View>
      <Text style={styles.nameText}>{item.cardNo}</Text>
      <View style={styles.bottomStyle}>
        <Text style={{fontSize: Scale(16), color: '#AB8F8E'}}>
          Set as default
        </Text>
        <Switch
      ...
      <View style={styles.buttonHeader}>
        ...
        <TouchableOpacity onPress={redirectToAddress}>
          <View style={styles.textStyle}>
            <Text style={styles.newCardStyle}>Add New Card</Text>
          </View>
        </TouchableOpacity>
      </View>
      <ImageBackground
