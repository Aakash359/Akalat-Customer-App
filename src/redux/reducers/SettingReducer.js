    ...
    export default function SettingReducer(state = initialState, action) {
      switch (action.type) {
        case ABOUTUS_REQUEST:
          return {...state,  aboutUsStatus:false, aboutUsResponse: action.payload, 
          };
        case ABOUTUS_SUCCESS:
          return {...state,  aboutUsStatus:true, aboutUsResponse: action.payload,
        };
        case ABOUTUS_FAILED:
          return {...state,  aboutUsStatus:false, aboutUsResponse: action.payload,         
        };
        case PRIVACY_REQUEST:
          return {...state,  privacyStatus:false, privacyResponse: action.payload, 
        };
        case PRIVACY_SUCCESS:
          return {...state,  privacyStatus:true, privacyResponse: action.payload,
        };
        case PRIVACY_FAILED:
          return {...state,  privacyStatus:false, privacyResponse: action.payload,         
        };
        ...
        case ADDADDRESS_REQUEST:
          return {...state,  addAddressStatus:false, addAddressResponse: action.payload, 
        };
        case ADDADDRESS_SUCCESS:
          return {...state,  addAddressStatus:true, addAddressResponse: action.payload,
        };
        ...
        case ADDRESSLIST_REQUEST:
          return {...state,  addressListStatus:false, addressListResponse: action.payload, 
        };
        case ADDRESSLIST_SUCCESS:
          return {...state,  addressListStatus:true, addressListResponse: action.payload,
        };
        ...
        case EDIT_PROFILE_SUCCESS:
          return {...state,  editProfileStatus:true, editProfileResponse: action.payload,
        };
        ...
        case MYORDER_LIST_SUCCESS:
          return {...state,  myOrderListStatus:true, myOrderListResponse: action.payload,
        };
